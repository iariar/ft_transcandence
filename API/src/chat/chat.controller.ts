...
export class ChatController {
	...
	chech_if_admin_or_owner(@GetUser() user: any, @Body() descriptiondto: descriptionDto) {
		...
		return this.chatservice.check_if_admin_or_owner(descriptiondto.description, user.username)
	}

	@Post('ban')
	bann(@GetUser() user: any, @Body() chatopdto: chatOpDto) {
		console.log(chatopdto)
		return this.chatservice.bann_user(chatopdto.description, chatopdto.username)
	}
